...
{
    muse::io::path_t basePath = muse::io::dirpath(filePath)  /* shadow diff: upstream calls filePath.toQString(), which does not exist without Qt; dirpath takes path_t directly */;
