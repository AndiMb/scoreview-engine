...
// shadow copy of src/importexport/midi/internal/midiexport/exportmidi.cpp —
// diffs against upstream, marked "shadow diff" below: the device is
// muse::io::IODevice, the QString/QFile overloads are not carried over, and
// qPrintable gives way to muse::String.
        ...
        for (auto is = bs; is != es; ++is) {
            ...
            default:
                ...
                LOGD("ExportMidi: unknown time signature %s",
                     ts.toString().toStdString().c_str() /* shadow diff: was qPrintable */);
                break;
            }
...
bool ExportMidi::write(muse::io::IODevice* device  /* shadow diff: was QIODevice* */, bool midiExpandRepeats, bool exportRPNs, const SynthesizerState& synthState)
{
...
// shadow diff: QString/QFile overloads not carried over

bool ExportMidi::write(muse::io::IODevice* device  /* shadow diff: was QIODevice* */, bool midiExpandRepeats, bool exportRPNs)
{
    SynthesizerState ss;
